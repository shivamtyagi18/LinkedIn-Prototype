    ...
    renderFieldemail(field) {
      ...
      renderFieldType(field) {
        ...
        return (
          <div className={className}>
            <label>{field.label}</label>
            <input style={{fontSize:"18px"}} className="form-control" type="text" value="Traveller" placeholder={field.placeholder}/>
            <div className="text-help">
              {touched ? error : ""}
            </div>
          </div>
            ...
            <nav class="navbar navbar-light navbar-fixed-top" style={{backgroundColor:"#283e4a",height:"5%"}}>
                <div class="container-fluid" >
                    <div class="navbar-header">
                        <a class="navbar-brand" href="/"><img alt="LinkedIn" class="site-header-logo__img img-responsive" role="presentation" src="https://static.licdn.com/sc/h/95o6rrc5ws6mlw6wqzy0xgj7y"></img></a>
                    </div>
                    ...
                    <div class="nav navbar-nav navbar-right navbar-brand" style={{marginTop:"-1%"}}>
                    <button class="btn btn-primary" style={{backgroundColor:"transparent",borderColor:"white",fontSize:"18px"}}>Sign In</button>
                    </div>
...
export default reduxForm({
    validate,
    form: "NewLoginForm"
  })(connect(mapStateToProps, { loginUser, logoutUser })(LoginNavbar));
