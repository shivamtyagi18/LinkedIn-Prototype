...
class RecruiterUserSearchBar extends Component {
    constructor(props){
      ...
      onSubmit(values) {
        ...
        this.props.searchUsers(values, () => {
         ...
         // this.props.history.push("/applicant/fetchJobs");
          window.location.href="/recruiter/fetchUsers";
    ...
    render(){
       ...
       // this.state.email=localStorage.getItem("email")
        ...
        return(
                    ...
                    <div class="col-sm-4" style={{marginTop:"-48px",width:"150px"}}>
                    <Field
                    name="User"
                    ...
                    <div class="col-sm-6" style={{width:"170px",marginTop:"-28px"}}>
...
export default reduxForm({
    validate,
    form: "UserSearchForm"
  })(connect(mapStateToProps, { loginUser, searchUsers })(RecruiterUserSearchBar));
