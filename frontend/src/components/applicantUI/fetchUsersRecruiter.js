...
import NavbarRecruiterHome from '../recruiterUI/navbarHome';
...
class SearchUserRecruiter extends Component {
    ...
    render(){
        ...
        let nav = <NavbarRecruiterHome navdata={this.props.navdata}/>
...
function mapStateToProps(state) {
  ...
  export default connect(mapStateToProps, { fetchUsers })(SearchUserRecruiter);